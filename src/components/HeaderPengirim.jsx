...
function HeaderPengirim() {
    return (
        ...
        <div className="container d-flex align-items-center justify-content-between"><Link className="logo d-flex align-items-center me-auto me-lg-0" to={"/"}><img src="images/logo.png" alt=""/>
